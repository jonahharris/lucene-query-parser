  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "geopoint_operator_exp": parse_geopoint_operator_exp,
      ...
      function parse_field_exp() {
        ...
        if (result0 === null) {
          ...
          result0 = parse_fieldname();
          if (result0 !== null) {
            result1 = parse_geopoint_operator_exp();
            if (result1 !== null) {
              result0 = [result0, result1];
            } else {
              result0 = null;
          ...
          if (result0 !== null) {
            result0 = (function(offset, fieldname, geopoint) { 
                  geopoint['type'] = 'geopoint';
                  geopoint['field'] = fieldname; 
                  return geopoint; 
              })(pos0, result0[0], result0[1]);
          }
          if (result0 === null) {
      ...
      function parse_decimal_exp() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, op, integer_part, fractional_part) { 
                //return parseFloat("0." + val.join(''));
                return parseFloat(op + integer_part.join('') + '.' + fractional_part.join(''));
      ...
      function parse_geopoint_operator_exp() {
        var result0, result1, result2, result3, result4, result5, result6;
        var pos0, pos1;
        ...
        if (result0 !== null) {
          result0 = (function(offset, lat, lon) { 
                return {
                    'lat': lat, 
                    'lon': lon
                };
